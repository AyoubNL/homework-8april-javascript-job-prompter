...
console.log('' + userInput.charAt(0).toUpperCase() + userInput.slice(1) + ' is een leuke afdeling om te werken. Er werken op dit moment ' + departments[userInput].numberOfEmployees + ' medewerkers.')
console.log(userInput)


const input = prompt(`Je koos ${userInput} Over welke functie wil je meer weten? Voer een getal tussen 0 en 3 in.\n` +
...
// } else {
//     console.error('Ongeldige invoer. Probeer het opnieuw door de pagina te verversen.')}